...
function sortByPricingDesc(hotels1, hotels2) {
  return hotels2.price - hotels1.price;
}
function sortByPricingAsc(hotels1, hotels2) {
...
function sortByRatingDesc(hotels1, hotels2) {
  return hotels2.rating - hotels1.rating;
}
function sortByRatingAsc(hotels1, hotels2) {
...
function sortByReviewsDesc(hotels1, hotels2) {
  return hotels2.reviews - hotels1.reviews;
}
function sortByReviewsAsc(hotels1, hotels2) {
...
function filterByAmenity(hotelsObj, amenity) {
  return hotelsObj.amenity.toLowerCase() === amenity;
}
...
function filterByCountry(hotelsObj, country) {
  return hotelsObj.country.toLowerCase() === country;
}
...
function filterByCategory(hotelsObj, category) {
  return hotelsObj.category.toLowerCase() === category;
}
